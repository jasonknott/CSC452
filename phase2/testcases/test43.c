/* Creates a mailbox with MAXSLOTS + 100 slots.  XXp1 fills half the slots using
 ...
 * empty slots.
 *
 * This is nearly identical to test42.c.  The difference is declaring
 * the mailbox to have MAXSLOTS + 100 slots, rather than MAXSLOTS slots.
 */
...
int start2(char *arg)
{
    ...
    mbox_id = MboxCreate(MAXSLOTS + 100, 50);
